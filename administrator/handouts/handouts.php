...
function make_list($row)  //1アカウントの情報を代入
{
  ...
  echo '<tr> <td>' . date_format($date, 'Y') . "年" . date_format($date, 'm') . "月" . date_format($date, 'd') . "日" .  '</td>'
    . '<td> <a ><a href = handouts_detail.php?id=' . $row["handout_id"] . '>' . $row["title"] . '</a></td>'
    .'<td> <a href="handout_fix.php?id=' . $row["handout_id"] .'" class="btn btn-primary"> 投稿修正 </a></td> </tr>';
}
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="handouts_add.php" class="btn btn-primary">新規追加</a>
              </div>
              <div class="card-body">
